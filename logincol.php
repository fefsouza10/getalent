...
<body>
                        ...
                        <div class="col-md-6 col-xl-5 mb-4">
                            ...
                            <div class="card wow fadeInRight" data-wow-delay="0.3s">
                                <div class="card-body">
                                    ...
                                    <!--Body-->
                                    <form method="POST" action="proc_login_col.php" class="border border-light p-5">
                                        <div class="md-form">
                                            <i class="fas fa-envelope prefix white-text active"></i>
                                            <input type="number" name="idColab" id="form2" class="white-text form-control">
                                            <label for="form2" class="active">Sua ID</label>
                                        </div>
                                        <div class="md-form">
                                            <i class="fas fa-lock prefix white-text active"></i>
                                            <input type="password" name="senhaColab" id="form4" class="white-text form-control">
                            ...
                            <div class="col-md-6 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
                                <button onclick="location.href = 'cadcol.php';" class="btn btn-indigo">Cadastrar</button>
                            </div>
                            <!--/.Form-->
                        </div>
                        <!--Grid column-->
    ...
    <!-- Custom JS-->
    <script type="text/javascript" src="js/logincol.js"></script>
</body>
